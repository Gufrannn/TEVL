"""
Pre-Training TEVL using TV and HowTo100M data
"""
...
from model.pretrain import TEVLForPretraining
...
def main(opts):
    ...
    if opts.load_partial_pretrained:
        ...
        # continue training
        model = TEVLForPretraining.from_pretrained(
            opts.model_config,
