"""
TEVL for Video Retrieval Tasks, shared by:
1. TVR
"""
from .vcmr import TEVLForVcmr


class TEVLForVr(TEVLForVcmr):
    ...
    def forward(self, batch, task='tvr_video_sub', compute_loss=True):
        if task in ['tvr_video_sub', 'tvr_video_only']:
            if compute_loss:
